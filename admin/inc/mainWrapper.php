            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link " href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  <img src="<?= !empty($rowNav['profile_picture']) && file_exists('admin/img/profile_picture/' . $rowNav['profile_picture']) ? 'img/profile_picture/' . $rowNav['profile_picture'] : 'https://placehold.co/100' ?>" alt="" width="35" height="35" class="rounded-circle">
                </a>
